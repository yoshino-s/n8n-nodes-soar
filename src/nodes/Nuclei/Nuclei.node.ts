...
export class Nuclei implements INodeType {
	description: INodeTypeDescription = {
		...
		version: 1,
		subtitle:
			"={{ 'nuclei' + ($parameter['batch'] ? ' (Batch)' : ' on ' + $parameter['target']) }}",
						...
						values: [
							{
								...
								options: [
									...
									},
									{
										...
										value: "-list",
										description:
											"Path to file containing a list of target URLs/hosts to scan (one per line) (string)",
									},
									{
										name: "Resume",
										value: "-resume",
										description:
											"Resume scan using resume.cfg (clustering will be disabled) (string)",
									},
									{
										name: "Scan All IPs",
										value: "-scan-all-ips",
									...
									},
									{
										...
										value: "-target",
										description:
											"Target URLs/hosts to scan (string[])",
									},
								],
							},
							{
